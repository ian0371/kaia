...
type ProposerFetcher interface {
	Author(head *types.Header) (common.Address, error)
}
...
func RpcMarshalEthHeader(head *types.Header, engine ProposerFetcher, chainConfig *params.ChainConfig, inclMiner bool) (map[string]interface{}, error) {
...
func RpcMarshalEthBlock(block *types.Block, engine ProposerFetcher, chainConfig *params.ChainConfig, inclMiner, inclTx, fullTx bool) (map[string]interface{}, error) {
