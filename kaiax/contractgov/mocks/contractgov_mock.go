...
//
//	mockgen -destination=kaiax/contractgov/mocks/contractgov_mock.go github.com/kaiachain/kaia/kaiax/contractgov/types ContractGovModule
//
...
func (mr *MockContractGovModuleMockRecorder) EffectiveParamSet(arg0 any) *gomock.Call {
...
func (m *MockContractGovModule) EffectiveParamsPartial(arg0 uint64) (map[string]any, error) {
	m.ctrl.T.Helper()
...
func (mr *MockContractGovModuleMockRecorder) EffectiveParamsPartial(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
