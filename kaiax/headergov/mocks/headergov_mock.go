...
func (m *MockHeaderGovModule) EffectiveParamsPartial(arg0 uint64) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHeaderGovModuleMockRecorder) FinalizeBlock(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHeaderGovModuleMockRecorder) Unwind(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
