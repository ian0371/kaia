...
func TestHeaderGovSerialization(t *testing.T) {
	tcs := []struct {
		...
		{serializedGovData: "0xa57b22676f7665726e616e63652e756e69747072696365223a3735303030303030303030307d", blockNum: 86486400, data: &GovernanceData{Params: map[string]interface{}{
			governance.GovernanceKeyMapReverse[params.UnitPrice]: uint64(750000000000),
		}}},
		{serializedGovData: "0xa57b22676f7665726e616e63652e756e69747072696365223a3235303030303030303030307d", blockNum: 90720000, data: &GovernanceData{Params: map[string]interface{}{
			governance.GovernanceKeyMapReverse[params.UnitPrice]: uint64(250000000000),
		}}},
		{serializedGovData: "0x9d7b22697374616e62756c2e636f6d6d697474656573697a65223a33317d", blockNum: 95558400, data: &GovernanceData{Params: map[string]interface{}{
			governance.GovernanceKeyMapReverse[params.CommitteeSize]: uint64(31),
		}}},
		{serializedGovData: "0xb8487b227265776172642e6d696e74696e67616d6f756e74223a2236343030303030303030303030303030303030222c227265776172642e726174696f223a2235302f34302f3130227d", blockNum: 105840000, data: &GovernanceData{Params: map[string]interface{}{
		...
		{serializedGovData: "0x9b7b227265776172642e726174696f223a2235302f32302f3330227d", blockNum: 119145600, data: &GovernanceData{Params: map[string]interface{}{
			governance.GovernanceKeyMapReverse[params.Ratio]: "50/20/30",
		}}},
		{serializedGovData: "0xb8497b22676f7665726e616e63652e676f7665726e696e676e6f6465223a22307863306362653163373730666263653165623737383662666261316163323131356435633061343536227d", blockNum: 126403200, data: &GovernanceData{Params: map[string]interface{}{
			governance.GovernanceKeyMapReverse[params.GoverningNode]: common.HexToAddress("0xc0cbe1c770fbce1eb7786bfba1ac2115d5c0a456"),
		}}},
		{serializedGovData: "0xb8477b226b697037312e676173746172676574223a31353030303030302c226b697037312e6d6178626c6f636b67617375736564666f7262617365666565223a33303030303030307d", blockNum: 140918400, data: &GovernanceData{Params: map[string]interface{}{
		...
		{serializedGovData: "0xb8647b22697374616e62756c2e636f6d6d697474656573697a65223a35302c227265776172642e6d696e74696e67616d6f756e74223a2239363030303030303030303030303030303030222c227265776172642e726174696f223a2235302f32352f3235227d", blockNum: 162086400, data: &GovernanceData{Params: map[string]interface{}{
